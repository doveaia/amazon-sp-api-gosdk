...
This Go SDK provides convenient methods to interact with Amazon's Selling Partner API.

## Installation

```bash
go get github.com/doveaia/amazon-sp-api-gosdk
```
